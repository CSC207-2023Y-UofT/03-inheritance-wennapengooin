...
public abstract class Bag {
     ...
     *
     * @return either the last item in the bag, or null
     */

    public String popItem() {
        if (this.numberOfContents > 0) {
            this.numberOfContents -= 1;
            String last_item = this.contents[this.numberOfContents];
    ...
    public void increaseCapacity(int n) {
        ...
        this.capacity += n;
        String[] increased_contents = new String[this.capacity];
        for (int i = 0; i < old_capacity; i++) {
            increased_contents[i] = this.contents[i];
        }
        this.contents = increased_contents;
